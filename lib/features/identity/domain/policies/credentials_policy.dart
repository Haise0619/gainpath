/// Field-level validation for sign-in and registration (SD-M1.1).
    ...
    return CredentialErrors(
      ...
      password: password.isEmpty
          ...
          : registering && password.length < minPasswordLength
              ...
              : null,
      confirm: registering && confirm != password ? 'Passwords do not match.' : null,
    );
  }
}
...
class CredentialErrors {
  ...
  bool get isValid => name == null && email == null && password == null && confirm == null;
